...
const ContactSection = () => {
  ...
  return (
    <div className="relative m-auto w-10/12 pb-32 dark:text-white md:pb-32">
      ...
      <div className="mt-16 grid md:grid-cols-2 gap-8">
        ...
        <div className="grid grid-cols-4 gap-3 h-full">
          {/* Email Card */}
          <div className="col-span-4 bg-white/5 backdrop-blur-md border border-white/10 p-4 rounded-lg hover:bg-white/10 transition-all group">
            <div className="flex items-center text-gray-300">
              <svg className="w-5 h-5 mr-3 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
              </svg>
              <div>
                <p className="text-xs text-gray-400">Email</p>
                <span className="text-sm text-white group-hover:text-white transition-colors">bilalkhalilkhankhail@gmail.com</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-4 grid grid-cols-2 gap-3">
            {/* GitHub Card */}
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-3 rounded-lg hover:bg-white/10 transition-all group">
              <a href="https://github.com/bilalmkhalil" 
                 target="_blank" 
            ...
            {/* LinkedIn Card */}
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-3 rounded-lg hover:bg-white/10 transition-all group">
              <a href="https://www.linkedin.com/in/bilal-khalil-khankhail" 
                 target="_blank" 
                 rel="noopener noreferrer"
                 className="w-full h-full flex flex-col items-center justify-center">
                <svg className="w-6 h-6 mb-1 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="col-span-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-lg overflow-hidden h-[220px] relative">
            ...
            ></iframe>
            <div className="absolute bottom-3 left-3 z-10 bg-white/10 backdrop-blur-md px-3 py-1.5 rounded-md">
