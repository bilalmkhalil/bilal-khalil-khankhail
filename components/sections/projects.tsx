  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center pt-8">
        <Link
          href="/projects"
          className="text-ink border-ink/10 bg-ink/5 hover:bg-ink/10 group relative inline-flex items-center overflow-hidden rounded-md border px-8 py-3 backdrop-blur-md transition-colors duration-300"
        >
